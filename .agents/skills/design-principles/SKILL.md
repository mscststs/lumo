...
description: Deep reference for Apple's Human Interface Guidelines design principles. Use when designing, reviewing, or implementing Apple-platform UI and UX — core principles (Purpose, Agency, Responsibility, Familiarity, Flexibility, Simplicity, Craft, Delight), page structure, tone and voice, best practices, evaluation checklists, or when integrating HIG guidance into iOS/macOS/watchOS/tvOS/visionOS app design workflows.
---
