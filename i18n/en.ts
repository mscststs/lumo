export const en = {
  ...
  options: {
    ...
    models: {
      ...
      fetchModelsConfigError: 'Configure the API URL and API key first.',
      fetchModelsError: 'Unable to fetch models.',
    ...
    ui: {
      ...
      toolbarUsage: 'Token Usage',
      visibilityAll: 'All Messages',
      visibilityAssistant: 'AI Messages Only',
      visibilityUser: 'User Messages Only',
    ...
    ocr: {
      ...
      description: 'When using a non-vision model, images are automatically converted to text descriptions using a configured vision model.',
      enabled: 'Enable OCR',
      enabledDesc: 'Convert images to text for non-vision models via a vision-capable model.',
      provider: 'OCR Provider',
      model: 'OCR Model',
      modelHint: 'Only vision-capable models are shown.',
      noVisionModels: 'No vision-capable models configured. Add one in the Models settings first.',
      prompt: 'OCR Prompt',
      promptDesc: 'Instructions sent alongside the image to the vision model.',
